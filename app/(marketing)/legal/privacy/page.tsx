  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-24 animate-fade-in">
      ...
      <div className="space-y-10 text-sm leading-relaxed text-muted-foreground [&_h2]:font-grotesk [&_h2]:text-lg [&_h2]:font-semibold [&_h2]:text-foreground [&_h2]:mb-3 [&_h3]:font-grotesk [&_h3]:text-sm [&_h3]:font-semibold [&_h3]:text-foreground [&_h3]:mb-2 [&_ul]:list-disc [&_ul]:pl-5 [&_ul]:space-y-1.5 [&_ol]:list-decimal [&_ol]:pl-5 [&_ol]:space-y-1.5">
        ...
        <p>
          unerr Inc. (&ldquo;unerr&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo;, or &ldquo;our&rdquo;)
          is committed to protecting your privacy. This Privacy Policy explains what information we collect,
          how we use it, and your rights regarding your data when you use the unerr platform, APIs, CLI
          tools, and related services (the &ldquo;Service&rdquo;).
        </p>
        ...
        <section>
          ...
          <p className="mt-2">
            <strong className="text-foreground">We do not store your full source code.</strong> We index
            structural metadata — the &ldquo;shape&rdquo; of your codebase — to build the knowledge graph.
            Source code is processed transiently during indexing and is not persisted.
          </p>
          ...
          <p>
            ...
            <a href="https://plausible.io" className="text-foreground underline hover:opacity-80" target="_blank" rel="noopener noreferrer">
              Plausible Analytics
            </a>{" "}
            for privacy-compliant website analytics — no cookies, no personal data collection,
            no cross-site tracking. We do not use Google Analytics or any advertising trackers.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-3">
            <strong className="text-foreground">We do not use your repository data to train machine learning
            models.</strong> Analysis is performed per-repository and per-organization. Your data is
        ...
        <section>
          ...
          <ul>
            <li>
              ...
              providers (cloud hosting, database services) that process data on our behalf under strict
              data processing agreements.
            </li>
            <li>
              <strong className="text-foreground">AI providers:</strong> When generating code intelligence
              outputs, we may send repository metadata to AI model providers. We use providers that do not
              train on customer data and we minimize the data sent to what is necessary for the analysis.
            </li>
            <li>
              <strong className="text-foreground">GitHub / GitLab:</strong> When you connect a repository,
              we interact with your Git hosting provider via their APIs using the permissions you grant.
              We access only the repositories and data you explicitly authorize.
            </li>
            <li>
              <strong className="text-foreground">Legal requirements:</strong> We may disclose information
              if required by law, subpoena, or legal process, or if we believe in good faith that disclosure
        ...
        <section>
          ...
          <ul>
            <li>
              <strong className="text-foreground">Account data:</strong> Retained while your account is active.
              Deleted within 30 days of account deletion.
            </li>
            <li>
              <strong className="text-foreground">Knowledge graph data:</strong> Deleted when you disconnect
              a repository or delete your account. Re-indexing builds a fresh graph from your current codebase.
            </li>
            <li>
              <strong className="text-foreground">Usage logs:</strong> Retained for up to 90 days for
              operational purposes, then anonymized or deleted.
            </li>
            <li>
              <strong className="text-foreground">Billing records:</strong> Retained as required by tax
              and accounting regulations (typically 7 years).
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul>
            ...
            <li><strong className="text-foreground">Deletion:</strong> Request deletion of your personal data. You can delete your account at any time from the dashboard settings.</li>
            <li><strong className="text-foreground">Portability:</strong> Request your data in a structured, commonly used format.</li>
        ...
        <section>
          ...
          <ul>
            ...
            <li><strong className="text-foreground">Consent:</strong> Where you have given explicit consent (e.g., marketing communications).</li>
            <li><strong className="text-foreground">Legal obligation:</strong> Where processing is required by law.</li>
          </ul>
          <p className="mt-3">
            Data may be transferred to the United States where our infrastructure is located. We use
            Standard Contractual Clauses (SCCs) approved by the European Commission to safeguard
        ...
        <section>
          ...
          <p>
            ...
            request deletion, and opt out of the &ldquo;sale&rdquo; of personal information.{" "}
        ...
        <section>
          ...
          <p>
            ...
            we will delete it promptly. If you believe a child has provided us with personal information,
            please contact us.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            by posting the updated policy on the Service and updating the &ldquo;Last updated&rdquo; date.
